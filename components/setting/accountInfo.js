        ...
        <form >
            ...
            <div className='grid grid-flow-row md:grid-cols-2 sm:grid-cols-1'>
                ...
                <div className='flex flex-col mb-8 sm:pr-6 md:pr-10 lg:pr-40 pr-4'>
                    ...
                    <input className='rounded-lg border bg-gray-300 py-2 px-3 text-grey-darkest' type="text" placeholder="First Name" value="Faisal" disabled/>
                </div>
                <div className='flex flex-col mb-8 sm:pr-6 md:pr-10 lg:pr-40 pr-4' >
                    <label className='mb-2 text-lg text-grey-darkest' htmlFor="Last Name">Last Name</label>
                    <input className='rounded-lg border bg-gray-300 py-2 px-3 text-grey-darkest' type="text" placeholder="Last Name"  value="Antu"  disabled/>
                </div>
                <div className='flex flex-col mb-8 sm:pr-6 md:pr-10 lg:pr-40 pr-4' >
                    <label className='mb-2 text-lg text-grey-darkest' htmlFor="InputEmail">Email address</label>
                    <input className='rounded-lg border bg-gray-300 py-2 px-3 text-grey-darkest' type="email" placeholder="Enter email"  value="hello@faisalantu.com"  disabled/>
                </div>
                <div className='flex flex-col mb-8 sm:pr-6 md:pr-10 lg:pr-40 pr-4' >
                    <label className='mb-2 text-lg text-grey-darkest' htmlFor="Phone Number">Phone Number</label>
                    <input className='rounded-lg border bg-gray-300 py-2 px-3 text-grey-darkest' type="tel" aria-describedby="Phone Number" placeholder="Phone Number"  value="017XXXXXXXXX"  disabled/>
                </div>
                <div className='flex flex-col mb-8 sm:pr-6 md:pr-10 lg:pr-40 pr-4' >
                    <label className='mb-2 text-lg text-grey-darkest' htmlFor="">Location</label>
                    <input className='rounded-lg border bg-gray-300 py-2 px-3 text-grey-darkest' type="text" aria-describedby="emailHelp" placeholder="location"  value="Dhaka, BD"  disabled/>
                </div>
                <div className='flex flex-col mb-8 sm:pr-6 md:pr-10 lg:pr-40 pr-4' >
                    <label className='mb-2 text-lg text-grey-darkest' >Student ID</label>
                    <input className='rounded-lg border bg-gray-300 py-2 px-3 text-grey-darkest' type="text" aria-describedby="emailHelp" placeholder="Student ID"  value="163 XXX XXX"  disabled/>
                </div>
